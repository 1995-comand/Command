    ...
    <div className="min-h-screen bg-gray-100 text-gray-800 mt-10">
        ...
        <section className="bg-white rounded-lg shadow-sm p-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <ul className="space-y-6">
              <li className="flex">
                <div className="flex-shrink-0 mt-1">
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-red-50 text-red-500 font-semibold text-sm">
                    –
                  </span>
                </div>
                <div className="ml-4">
              ...
              <li className="flex">
                <div className="flex-shrink-0 mt-1">
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-pink-50 text-pink-500 font-semibold text-sm">
                    +
                  </span>
                </div>
                <div className="ml-4">
                  <div className="text-sm font-semibold">
                    Theme 2. Orci commodo, viverra orci mollis ut euismod.
                  </div>
                </div>
              </li>
              ...
              <li className="flex">
                ...
                <div className="ml-4">
                  <div className="text-sm font-semibold">
                    Theme 3. Sagittis vitae facilisi rutrum amet mauris quisque
                    vel.
                  </div>
                </div>
              </li>
              ...
              <li className="flex">
                ...
                <div className="ml-4">
                  <div className="text-sm font-semibold">
                    Theme 4. In id dolor quis nunc, urna hendrerit pharetra.
                  </div>
                </div>
              </li>
            </ul>
          ...
          <aside className="lg:col-span-4 flex items-start">
            <div className="w-full bg-white border border-gray-100 rounded-lg shadow-md p-6">
              ...
              <div className="mt-6 text-xs text-gray-500 tracking-wide">
                PRICE
              </div>
              <div className="mt-2 text-gray-900 font-semibold">Free</div>
              <p className="mt-2 text-sm text-gray-500">
                Nulla sem adipiscing adipiscing felis fringilla. Adipiscing
                mauris quam ac elit tristique orci.
              </p>

              <a
                className="block mt-4 text-sm text-pink-500 hover:underline"
                href="#"
              >
                EVENT ON FACEBOOK
              </a>

              <button className="mt-6 w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 rounded">
                Join the event
              </button>
            </div>
          </aside>
      ...
      <footer className="max-w-6xl mx-auto px-6 py-10 text-sm text-gray-500">
        <div className="text-center">
          © {new Date().getFullYear()} CREATE X. All rights reserved.
        </div>
      </footer>
    </div>
  );
